...
import { getTransactions, createPOSCheckout, createTransaction, deleteTransaction } from '../controllers/transactionController';
...
router.post('/checkout', protect, authorize('super_admin', 'admin', 'user'), requireScreenAccess('pos'), createPOSCheckout);
